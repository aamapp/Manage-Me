  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <div 
        ...
        className={`w-full px-4 py-3.5 bg-transparent border border-slate-200 rounded-xl font-bold text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 flex items-center justify-between cursor-pointer transition-all ${isOpen ? 'ring-2 ring-indigo-500 border-indigo-500' : ''}`}
