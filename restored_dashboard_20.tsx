...
export const Dashboard: React.FC = () => {
  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 5; i >= 0; i--) {
      // Using Date constructor to handle month wrap-around automatically
      // e.g., if currentMonth is 0 (Jan), 0-1 becomes -1, which Date interprets as Dec of previous year
      ...
      const monthlySum = incomeRecords.filter(record => {
        ...
        return recDate.getMonth() === targetMonthIndex && recDate.getFullYear() === targetYear;
  ...
  return (
    <div className="space-y-5 w-full max-w-full overflow-hidden pt-2">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm w-full overflow-hidden">
        ...
        {/* Adjusted container height and removing negative margins for better safety */}
