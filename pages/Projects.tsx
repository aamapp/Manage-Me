                              ...
                              <div className="absolute right-0 top-full mt-1 w-36 bg-white rounded-xl shadow-xl border border-slate-100 z-20 flex flex-col py-1.5 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                  ...
                                  <button 
                                      onClick={(e) => { 
                                        e.stopPropagation(); 
                                        if (!isOnline) {
                                          showToast('অফলাইনে প্রজেক্ট ডিলিট করা যাবে না', 'error');
                                          return;
                                        }
                                        initiateDelete(p.id); 
                                      }}
                    ...
                    <div ref={detailsRef} className="bg-white pb-4 relative rounded-[2rem] overflow-hidden">
                      ...
                      <div className="pt-6 px-6 pb-2 relative z-10">
                          <div className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                  <h2 className="text-xl font-black text-slate-800 mb-1 leading-tight" style={{ fontFamily: "'Kohinoor Bangla', sans-serif" }}>{viewProject.name}</h2>
