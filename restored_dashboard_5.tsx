...
export const Dashboard: React.FC = () => {
  ...
  // Using lowercase property names from types.ts
  const totalIncome = projects.reduce((acc, curr) => acc + (curr.paidamount || 0), 0);
  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 5; i >= 0; i--) {
      ...
      // Filter logic can be updated later when income records are fully synced
      result.push({
